...
class Config:
    ...
    # dataset
    train_root = '/mnt/mfs/yiling/data/face/webface/CASIA-WebFace'
    test_root = "/mnt/mfs/yiling/data/face/lfw/lfw-align-128"
    test_list = "/mnt/mfs/yiling/data/face/lfw/lfw_test_pair.txt"
